...
SERVO_t vesc_ppm[3], servo, servo1, regulator, servo_ring;
...
float fx_accel, fy_accel, fz_accel, roll, pitch, yaw;
...
extern float pickVG[7];
int32_t pick_enc, pick_tol, pick_target_enc;
